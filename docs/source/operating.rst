[tssproject2ksa001-b4b4] Operating Details
====================================

Generated On: 2024-11-05 15:58:36 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=34817  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   docker run -d -p 48865:48865 -p 34527:34527 -p 58707:58707 \-\-env TSS=0 \-\-env SOLUTIONNAME=tssproject2ksa001-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_dag-tssproject2ksa001-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=48865  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=34527  \-\-env SOLUTIONVIPERVIZPORT=58707 \-\-env DOCKERUSERNAME='kasunsam'  \-\-env EXTERNALPORT=34817 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasunsam/tssproject2ksa001-b4b4-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=58707
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=48865
...
It can be accessed by entering: http://localhost:34527
...
.. important::
   http://localhost:58707/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:58707/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:58707/<html file>
...
.. important::
   solution_preprocessing_dag-tssproject2ksa001-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=48865, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46391, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42151, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=44073, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33103, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46563, HPDEHOST=127.0.1.1, HPDEPORT=40561, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42909

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6790-tssproject2ksa001-b4b4,solution_preprocessing_dag-tssproject2ksa001-b4b4, python-preprocess-8218-tssproject2ksa001-b4b4,solution_preprocessing_dag-tssproject2ksa001-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
